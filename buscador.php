...
<?php
        ...
        //$consulta = "SELECT * FROM `b2b` WHERE `offer`AND`descr` LIKE `$search` ORDER BY `id` DESC"; //idea inicial
        
        //$consulta = "SELECT * FROM `b2b` WHERE `offer` LIKE '%$search%' OR `descr` LIKE '%$search%' ORDER BY `id` DESC"; //funcionando en mysql
